...
export const COPY_RULE_RUNTIME = Object.freeze([
  ...
  card('COPY-010',['days.*.description','days.*.spots.*.description'],['写客户做/看什么、现场如何展开、为何值得、如何承接整程；已有结构化具体车程时正文不重复数字时长；普通体验日46—220字，转场/返程日24—130字；相邻DAY重点不同'],['前往—参观—返回流水账、重复当日节奏中的数字车程、无依据时段/资质/动物/活动、细节堆砌、跨日同义重复、空泛套话'],['当前DAY原始事实、前后DAY摘要、整程DAY角色'],['动作、画面、价值和前后推进均基于事实，信息密度适合长图阅读'],['每次只修一个DAY，复杂问题直接高推理；仍失败待修订'],['day_progression','day_action_scene','day_value','day_length','day_fact_dump','day_travel_time_duplicate','day_near_duplicate','day_no_supplier_log','sentence_fact_evidence'],'complex'),
