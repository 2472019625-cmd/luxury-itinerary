...
const GROUPS = {
  ...
  VIS: { stage: 'final-qa/export', implementation: ['server/final-layout-review.mjs','renderer/render.mjs','src/App.jsx','src/styles.css'], tests: ['tests/final-output-qa.test.mjs','renderer/test-dynamic.mjs'], failure: '布局或输出硬缺陷阻止正式导出；主观审美转人工记录。' },
