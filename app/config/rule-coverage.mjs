const TYPES = {
  ...
  'COPY-001':'B+C+D','COPY-002':'A+B+C','COPY-003':'A+B+C','COPY-004':'B+C','COPY-005':'B+C','COPY-006':'A+B+C','COPY-007':'A+B+C','COPY-008':'A+B+C','COPY-009':'A+B+C','COPY-010':'B+C','COPY-011':'A+B+C','COPY-012':'A+B+C','COPY-013':'B+C+D','COPY-014':'A+B+C','COPY-015':'B+C+D','COPY-016':'A+C','COPY-017':'A+C',
