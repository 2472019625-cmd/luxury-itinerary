...
const data = {
  ...
  highlights:['一家一团：专属节奏不用迁就陌生团友','在地服务：定制师协同减少无效等待','草原初见：把晨昏光线留给旷野体验'],
...
test('generation preview may carry copy issues into editor but formal export still blocks them', () => {
  const edited = { ...data, copyQuality: { version:'3.2', passed:false, needsReview:true }, subtitle:'非凡之旅', highlights:['顶奢连住'], notes:[] };
