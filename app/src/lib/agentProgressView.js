export const SIMPLE_DESIGNER_STAGES = [
  ...
  { key: "planner", sourceKeys: ["planner"], label: "梳理路线与体验重点", shortLabel: "规划", routePosition: 8 },
  { key: "content_creation", sourceKeys: ["copy_skill", "image_skill"], label: "完善客户文案与视觉素材", shortLabel: "内容制作", routePosition: 18 },
  { key: "program_writeback", sourceKeys: ["program_writeback"], label: "核对客户行程重要信息", shortLabel: "检查", routePosition: 82 },
  { key: "renderer", sourceKeys: ["renderer"], label: "排版并检查客户版长图", shortLabel: "长图", routePosition: 94 },
];
